...
#     # 🔥 FIXED: Explicitly clear historical metrics cache to prevent dashboard telemetry contamination
#     engine_status["status"] = "Cloud download done! Transferring to Google Drive..."
#     engine_status["speed"] = "0.00"
#     engine_status["progress"] = "100.00"
...
#     # 🔥 FIXED: Added --stats-one-line to force clean single-line telemetry rows
#     rclone_cmd = [
#         "rclone", "copy", source_dir, dest_dir, 
#         "--config", resolved_config_path,
#         "--transfers", "10", 
...
#     # 🔥 FIXED: Custom stream decoder slicing lines on both \r and \n boundaries
#     buf = ""
#     while True:
...
#             # Locked telemetry analyzer block gated behind explicit speed validation
#             if cleaned_line.lower().startswith("transferred:") and "," in cleaned_line:
#                 speed_match = speed_regex.search(cleaned_line)
#                 if speed_match:  
#                     engine_status["upload_speed"] = speed_match.group(1)
...
#             # 🔥 FIXED: Scan metrics dynamically. If a line has a speed, progress pattern, and an ETA ticker, 
#             # it is our telemetry summary line, regardless of what rclone prepends to it.
#             speed_match = speed_regex.search(cleaned_line)
#             prog_match = progress_regex.search(cleaned_line)
#             eta_match = eta_global_regex.search(cleaned_line)
            
#             if speed_match and prog_match and eta_match:
#                 engine_status["upload_speed"] = speed_match.group(1)
#                 engine_status["upload_progress"] = prog_match.group(1)
#                 engine_status["upload_eta"] = eta_match.group(1)
#         else:
...
#     # Open the log file locally and stream output line by line
...
#                 # Write the line directly to the local text file
...
def download_huggingface_worker(repo_id: str, repo_type: str):
    ...
    try:
        ...
        # 3. 🔥 THROUGHPUT-DRIVEN THREAD POOL SCALING MATRIX (YOUR STRATEGY)
